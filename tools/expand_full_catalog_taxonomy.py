...
def main():
    ...
    subcat_mapping_rules = [
        ...
        (r"краск|эмаль|колер|лакокрас", "type:paint", "краска"),
        (r"грунт|праймер|бетоноконтакт", "type:primer", "грунтовка"),
        (r"шпатлев|шпаклев|паста финиш", "type:putty", "шпаклёвка"),
        (r"штукатур", "type:plaster", "штукатурка"),
        (r"лак", "type:varnish", "лак"),
        (r"кист", "type:brush", "кисть"),
        (r"валик|ролик", "type:roller", "валик"),
        (r"плиточн.*клей|клей.*плит", "type:tile_glue", "плиточный клей"),
        (r"брус|брусок|рейка|вагонка|доска|пиломатериал", "type:brusok", "брусок"),
